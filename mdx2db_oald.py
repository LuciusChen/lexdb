...
Supports OALD4 双解版
Uses the same schema as mdx2lexdb.py for compatibility.
"""
...
# ============================================================
# Schema Definition (same as mdx2lexdb.py)
# ============================================================
...
def create_database(db_path):
    ...
    conn.execute("INSERT OR REPLACE INTO _lexdb_meta (key, value) VALUES ('schema_version', ?)",
                 (SCHEMA_VERSION,))
    conn.commit()
    return conn
